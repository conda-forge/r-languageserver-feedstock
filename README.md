...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-languageserver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-languageserver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-languageserver
# for installing globally
pixi global install r-languageserver
```
...
It is possible to list all of the versions of `r-languageserver` available on your platform:
...
```
pixi search r-languageserver --channel conda-forge
```
